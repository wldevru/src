...
QT_MOC_LITERAL(1, 12, 13), // "changedOutPWM"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 1), // "n"
QT_MOC_LITERAL(4, 29, 6), // "update"
QT_MOC_LITERAL(5, 36, 9) // "updatePWM"

    },
    "WLModulePWM\0changedOutPWM\0\0n\0update\0"
    "updatePWM"
};
...
void WLModulePWM::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WLModulePWM *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changedOutPWM((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->update(); break;
        case 2: _t->updatePWM(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WLModulePWM::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WLModulePWM::changedOutPWM)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WLModulePWM::changedOutPWM(int _t1)
{
