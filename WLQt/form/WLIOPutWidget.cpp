...
WLIOPutWidget::WLIOPutWidget(QWidget *parent)
	: QTabWidget(parent)
{
//ui.setupUi(this);
...
WLIOPutWidget::~WLIOPutWidget()
{
delete m_IconOn;
delete m_IconOff;
}

void WLIOPutWidget::Init()
{
...
void WLIOPutWidget::setDCTableInput(QModelIndex mindex)
{
int row=mindex.row();
...
void WLIOPutWidget::setDCTableOutput(QModelIndex mindex)
{
int row=mindex.row();
...
void WLIOPutWidget::setDCTableOutPWM(QModelIndex mindex)
{
int row=mindex.row();
