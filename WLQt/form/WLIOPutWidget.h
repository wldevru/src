#ifndef WLIOPUTWIDGET_H
#define WLIOPUTWIDGET_H
...
class WLIOPutWidget : public QTabWidget
{
	Q_OBJECT

public:
    WLIOPutWidget(QWidget *parent = nullptr);
	~WLIOPutWidget();
